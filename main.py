...
# Admin Only decorator for 'edit' and 'delete' functions
...
# CONFIGURE TABLES
# Relationships:
# User (parent) -> BlogPost (child), one to many
# User (parent) -> Comment (child), one to many
# BlogPost (parent) -> Comment (child), one to many
...
class BlogPost(db.Model):
    ...
    # Create reference to the Comment object, the "parent_post" refers to the parent_post property
